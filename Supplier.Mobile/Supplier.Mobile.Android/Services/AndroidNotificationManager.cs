...
[assembly: Dependency(typeof(Supplier.Droid.Services.AndroidNotificationManager))]
namespace Supplier.Droid.Services
{
    public class AndroidNotificationManager : INotificationManager
    {
        const string channelId = "default.supplier.tank-eyes";
        const string channelName = "Default Supplier";
